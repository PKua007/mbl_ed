...
TEST_CASE("CavityHamiltonianGenerator: onsite energy") {
    ...
    SequenceDisorderGenerator disorderGenerator({1, 2, 3});
...
TEST_CASE("CavityHamiltonianGenerator: short interactions") {
    ...
    CavityHamiltonianGenerator hamiltonianGenerator(fockBase, 0, 0, 1, ConstantDisorderGenerator(0));
...
TEST_CASE("CavityHamiltonianGenerator: long interactions") {
    FockBaseGenerator baseGenerator;
    FockBase fockBase = baseGenerator.generate(3, 3);
    CavityHamiltonianGenerator hamiltonianGenerator(fockBase, 0, 0, 0, ConstantDisorderGenerator(0));
